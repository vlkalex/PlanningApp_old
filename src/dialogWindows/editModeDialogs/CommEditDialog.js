...
export function CommEditDialog(props) {
    ...
    useEffect(() => {
        ...
        setPhoneNumber(selectedTask.contact.phoneNumber);
        setEmail(selectedTask.contact.email);
        ...
        >
            <div style={{ }}>
                ...
                <div style={{ alignItems:'center', display: 'flex', flexDirection:'row' }}>
                    ...
                    <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'start', padding: '10px 0px', marginLeft: '1em' }}>
                        <EmailIcon />
                        <TextField
                            label="Email"
                            variant="outlined"
